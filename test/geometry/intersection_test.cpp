...
Eigen::Vector3f point5 = {1.f, 0.f, 0.f};
Eigen::Vector3f point6 = {6.f, 0.f, 0.f};
Eigen::Vector3f point3 = {3.f, 0.f, 0.f};
Eigen::Vector3f point4 = {6.f, 3.f, 8.f};
...
{
  // far test
  auto sphere = bounding_volume{hnll::vec3(0.f, 0.f, 10.f), 3};
